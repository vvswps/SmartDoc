        ...
        try {
            ...
            switch (fileType.toLowerCase()) {
                case "research":
                    ...
                    UserDtls uuser = UserRepositary.findByEmail(principal.getName());
                    

                    if (role.equals("ROLE_HOD")) {
                        // The user is a HOD
                        return ResponseEntity.status(HttpStatus.FOUND).location(URI.create("hod/research")).build();
                    } else {
                ...
                case "award":
                    ...
                    if (role.equals("ROLE_HOD")) {
                        // The user is a HOD
                        return ResponseEntity.status(HttpStatus.FOUND).location(URI.create("hod/awards")).build();
                    } else {
                        // The user is a teacher
                        return ResponseEntity.status(HttpStatus.FOUND).location(URI.create("teacher/awards")).build();
                    }
                ...
                case "fdp":
                    ...
                    if (role.equals("ROLE_HOD")) {
                        // The user is a HOD
                        return ResponseEntity.status(HttpStatus.FOUND).location(URI.create("hod/fdp")).build();
                    } else {
                        // The user is a teacher
                        return ResponseEntity.status(HttpStatus.FOUND).location(URI.create("teacher/fdp")).build();
                    }
